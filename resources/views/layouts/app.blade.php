<!DOCTYPE html>
<html lang="es" x-data="{ mobileMenuOpen: false }" :class="mobileMenuOpen ? 'overflow-hidden' : ''" class="scroll-smooth overflow-x-hidden w-full">
<head>
    <meta charset="UTF-8">
...
<body :class="mobileMenuOpen ? 'overflow-hidden' : ''" class="font-sans text-bosque bg-piedra antialiased flex flex-col min-h-screen pb-[64px] md:pb-0 overflow-x-hidden w-full">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12">
                <div>
                    ...
                    <div class="flex items-center gap-3 text-stone-300/80">
                        <a href="https://www.instagram.com/montanaroja.casadetierra?igsh=MTRnZWk1MXhjNmxtMA==" target="_blank" rel="noopener noreferrer" class="w-7 h-7 rounded-full border border-stone-500/40 flex items-center justify-center hover:text-white hover:border-white transition-colors">
                        ...
                        <a href="https://www.tiktok.com/@montanaroja_cuicatlan?_r=1&_t=ZS-98draPqFlH6" target="_blank" rel="noopener noreferrer" class="w-7 h-7 rounded-full border border-stone-500/40 flex items-center justify-center hover:text-white hover:border-white transition-colors">
                        ...
                        <a href="https://www.facebook.com/share/19FbT5nf7q/" target="_blank" rel="noopener noreferrer" class="w-7 h-7 rounded-full border border-stone-500/40 flex items-center justify-center hover:text-white hover:border-white transition-colors">
